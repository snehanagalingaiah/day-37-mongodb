...
//db.products.find().limit(1).skip(9)
...
//there were no such products which had both the conditios met hence i got 0 documents as output so i have used or condition for the below query
...
db.products.aggregate([
  ...
  //total of 4 documents were deleted. 2 documents with price 36 and 2 others with price 47. all of them were deleted.
  
  db.products.find(); // after the execution of above deletion query 21 docs were left
